...
planfs_v1:
  ...
  objective: No remaining knowledge code paths; build passes
  status: todo
  budgets:
    max_files: 16
    max_diff_lines: 1500
  ...
  dod:
    success_criteria:
    - No remaining knowledge code paths; build passes
    tests:
    - make check
    blockers:
    - No dead code, no hidden feature flags; remove migrations cleanly
    rollback:
...
- make check
## Proof
- FILE:docs/plans/flagship-ux-v2-remove-knowledge-cards/Slice-2.md
## Rollback
- Rollback slice 2 changes.
## Risks

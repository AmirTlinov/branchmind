...
planfs_v1:
  ...
  objective: Knowledge commands removed from docs/contracts and MCP registry
  status: todo
  budgets:
    max_files: 16
    max_diff_lines: 1500
  ...
  dod:
    success_criteria:
    - Knowledge commands removed from docs/contracts and MCP registry
    - Storage no longer persists knowledge entities; migrations updated
    - Unknown-knowledge calls return UNKNOWN_CMD with recovery hint
    - Verify passes
    tests:
    - make check
    blockers:
...
- make check
## Proof
- FILE:docs/plans/flagship-ux-v2-planfs-no-knowledge-golden-surface/Slice-1.md
## Rollback
- Rollback slice 1 changes.
## Risks

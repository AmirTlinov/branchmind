...
use super::super::ResolvedStepContext;
use crate::*;
use serde_json::{Value, json};

pub(super) struct ThinkPackCapsuleArgs<'a> {
...
pub(super) fn build_think_pack_capsule(args: ThinkPackCapsuleArgs<'_>) -> Value {
...
pub(super) fn filter_think_pack_capsule_to_cards(capsule: &mut Value, cards_snapshot: &[Value]) {

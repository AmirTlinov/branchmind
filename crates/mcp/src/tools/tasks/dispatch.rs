...
pub(crate) fn dispatch_tasks_tool(
    ...
    let resp = match name {
        ...
        "macro_delegate" => server.tool_tasks_macro_delegate(args),
        "macro_fanout_jobs" => server.tool_tasks_macro_fanout_jobs(args),
        "macro_merge_report" => server.tool_tasks_macro_merge_report(args),
        ...
        "mindpack" => server.tool_tasks_mindpack(args),
        ...
        "jobs_create" => server.tool_tasks_jobs_create(args),
        "jobs_list" => server.tool_tasks_jobs_list(args),
        "jobs_radar" => server.tool_tasks_jobs_radar(args),
        "jobs_open" => server.tool_tasks_jobs_open(args),
        "jobs_tail" => server.tool_tasks_jobs_tail(args),
        "jobs_claim" => server.tool_tasks_jobs_claim(args),
        "jobs_message" => server.tool_tasks_jobs_message(args),
        "jobs_report" => server.tool_tasks_jobs_report(args),
        "jobs_complete" => server.tool_tasks_jobs_complete(args),
        "jobs_requeue" => server.tool_tasks_jobs_requeue(args),
        "runner_heartbeat" => server.tool_tasks_runner_heartbeat(args),
        _ => return None,
    };
    Some(resp)
}

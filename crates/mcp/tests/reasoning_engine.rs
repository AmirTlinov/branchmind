...
fn reasoning_engine_receipts_parsing_handles_unicode_text() {
    ...
    server.request(json!({
        ...
        "id": 2,
        "method": "tools/call",
        "params": { "name": "system", "arguments": { "op": "call", "cmd": "system.init", "args": { "workspace": "ws_re_unicode" } } }
    }));
    ...
    let plan = server.request(json!({
        ...
        "id": 3,
        "method": "tools/call",
        "params": { "name": "tasks", "arguments": { "op": "call", "cmd": "tasks.plan.create", "args": { "workspace": "ws_re_unicode", "kind": "plan", "title": "Plan" } } }
    }));
    ...
    let task = server.request(json!({
        ...
        "id": 4,
        "method": "tools/call",
        "params": { "name": "tasks", "arguments": { "op": "call", "cmd": "tasks.plan.create", "args": { "workspace": "ws_re_unicode", "kind": "task", "parent": plan_id, "title": "Task" } } }
    }));
    ...
    server.request(json!({
        ...
        "id": 6,
        "method": "tools/call",
        "params": { "name": "think", "arguments": { "op": "call", "cmd": "think.pin", "args": { "workspace": "ws_re_unicode", "targets": ["E-RU"], "pinned": true } } }
    }));
    ...
    let snapshot = server.request(json!({
        ...
        "id": 7,
        "method": "tools/call",
        "params": { "name": "tasks", "arguments": { "op": "call", "cmd": "tasks.snapshot", "args": { "workspace": "ws_re_unicode", "task": task_id, "view": "smart" } } }
    }));
...
fn reasoning_engine_think_watch_bm4_blind_spot_emits_action() {
    ...
    let init = server.request(json!({
        ...
        "id": 2,
        "method": "tools/call",
        "params": { "name": "system", "arguments": { "op": "call", "cmd": "system.init", "args": { "workspace": "ws_re_engine" } } }
    }));
    ...
    server.request(json!({
        ...
        "id": 3,
        "method": "tools/call",
        "params": { "name": "think", "arguments": { "op": "call", "cmd": "think.add.hypothesis", "args": { "workspace": "ws_re_engine", "card": { "title": "Hypo", "text": "No tests yet" } } } }
    }));
    ...
    let watch = server.request(json!({
        ...
        "id": 4,
        "method": "tools/call",
        "params": { "name": "think", "arguments": { "op": "call", "cmd": "think.watch", "args": { "workspace": "ws_re_engine", "engine_signals_limit": 10, "engine_actions_limit": 10 } } }
    }));
...
fn reasoning_engine_lane_decision_suggests_publish_to_shared() {
    ...
    server.request(json!({
        ...
        "id": 2,
        "method": "tools/call",
        "params": { "name": "system", "arguments": { "op": "call", "cmd": "system.init", "args": { "workspace": "ws_re_lane" } } }
    }));
...
fn reasoning_engine_daily_engine_calls_auto_disclose_full_for_hidden_targets() {
    ...
    server.request(json!({
        ...
        "id": 2,
        "method": "tools/call",
        "params": { "name": "system", "arguments": { "op": "call", "cmd": "system.init", "args": { "workspace": "ws_re_lane_daily" } } }
    }));
...
fn reasoning_engine_tasks_resume_super_bm5_runnable_test_suggests_capture() {
    ...
    let resume = server.request(json!({
        ...
        "id": 4,
        "method": "tools/call",
        "params": { "name": "tasks", "arguments": { "op": "call", "cmd": "tasks.resume.super", "args": { "workspace": "ws_re_tasks", "task": task_id, "read_only": true, "max_chars": 8000, "engine_actions_limit": 10, "engine_signals_limit": 10 } } }
    }));
    let resume_text = extract_tool_text(&resume);
    let engine = resume_text
        .get("result")
...
fn reasoning_engine_think_watch_bm1_contradiction_emits_signal_and_action() {
    ...
    server.request(json!({
        ...
        "id": 2,
        "method": "tools/call",
        "params": { "name": "system", "arguments": { "op": "call", "cmd": "system.init", "args": { "workspace": "ws_re_bm1" } } }
    }));
    ...
    server.request(json!({
        ...
        "id": 6,
        "method": "tools/call",
        "params": { "name": "think", "arguments": { "op": "call", "cmd": "think.pin", "args": { "workspace": "ws_re_bm1", "targets": ["E1", "E2"], "pinned": true } } }
    }));
    ...
    let watch = server.request(json!({
        ...
        "id": 7,
        "method": "tools/call",
        "params": { "name": "think", "arguments": { "op": "call", "cmd": "think.watch", "args": { "workspace": "ws_re_bm1", "limit_candidates": 10, "engine_signals_limit": 20, "engine_actions_limit": 20 } } }
    }));
    let watch_text = extract_tool_text(&watch);
...
fn reasoning_engine_think_watch_bm8_stale_evidence_prompts_rerun() {
    ...
    server.request(json!({
        ...
        "id": 2,
        "method": "tools/call",
        "params": { "name": "system", "arguments": { "op": "call", "cmd": "system.init", "args": { "workspace": "ws_re_bm8" } } }
    }));
    ...
    server.request(json!({
        ...
        "id": 5,
        "method": "tools/call",
        "params": { "name": "think", "arguments": { "op": "call", "cmd": "think.pin", "args": { "workspace": "ws_re_bm8", "targets": ["EV1"], "pinned": true } } }
    }));
    ...
    server.request(json!({
        ...
        "id": 6,
        "method": "tools/call",
        "params": { "name": "think", "arguments": { "op": "call", "cmd": "think.trace.step", "args": { "workspace": "ws_re_bm8", "step": "bump clock" } } }
    }));
    ...
    let watch = server.request(json!({
        ...
        "id": 7,
        "method": "tools/call",
        "params": { "name": "think", "arguments": { "op": "call", "cmd": "think.watch", "args": { "workspace": "ws_re_bm8", "limit_candidates": 10, "engine_signals_limit": 20, "engine_actions_limit": 20 } } }
    }));
    let watch_text = extract_tool_text(&watch);
...
fn reasoning_engine_bm2_weak_evidence_emits_warning() {
    ...
    server.request(json!({
        ...
        "id": 2,
        "method": "tools/call",
        "params": { "name": "system", "arguments": { "op": "call", "cmd": "system.init", "args": { "workspace": "ws_re_bm2" } } }
    }));
    ...
    server.request(json!({
        ...
        "id": 4,
        "method": "tools/call",
        "params": { "name": "think", "arguments": { "op": "call", "cmd": "think.pin", "args": { "workspace": "ws_re_bm2", "targets": ["EVW"], "pinned": true } } }
    }));
    ...
    let watch = server.request(json!({
        ...
        "id": 5,
        "method": "tools/call",
        "params": { "name": "think", "arguments": { "op": "call", "cmd": "think.watch", "args": { "workspace": "ws_re_bm2", "engine_signals_limit": 20, "engine_actions_limit": 20, "limit_candidates": 10 } } }
    }));
    let watch_text = extract_tool_text(&watch);
    let engine = watch_text
        .get("result")
...
fn reasoning_engine_bm3_low_confidence_pinned_decision_emits_warning() {
    ...
    server.request(json!({
        ...
        "id": 2,
        "method": "tools/call",
        "params": { "name": "system", "arguments": { "op": "call", "cmd": "system.init", "args": { "workspace": "ws_re_bm3" } } }
    }));
    ...
    server.request(json!({
        ...
        "id": 4,
        "method": "tools/call",
        "params": { "name": "think", "arguments": { "op": "call", "cmd": "think.pin", "args": { "workspace": "ws_re_bm3", "targets": ["DLOW"], "pinned": true } } }
    }));
    ...
    let watch = server.request(json!({
        ...
        "id": 5,
        "method": "tools/call",
        "params": { "name": "think", "arguments": { "op": "call", "cmd": "think.watch", "args": { "workspace": "ws_re_bm3", "engine_signals_limit": 20, "engine_actions_limit": 20, "limit_candidates": 10 } } }
    }));
    let watch_text = extract_tool_text(&watch);
    let engine = watch_text
        .get("result")
...
fn reasoning_engine_bm9_tradeoff_suggests_criteria_matrix_playbook() {
    ...
    server.request(json!({
        ...
        "id": 2,
        "method": "tools/call",
        "params": { "name": "system", "arguments": { "op": "call", "cmd": "system.init", "args": { "workspace": "ws_re_bm9" } } }
    }));
    ...
    let watch = server.request(json!({
        ...
        "id": 4,
        "method": "tools/call",
        "params": { "name": "think", "arguments": { "op": "call", "cmd": "think.watch", "args": { "workspace": "ws_re_bm9", "engine_signals_limit": 20, "engine_actions_limit": 20, "limit_candidates": 10 } } }
    }));
    let watch_text = extract_tool_text(&watch);
    let engine = watch_text
        .get("result")
...
fn reasoning_engine_bm6_assumption_not_open_but_used_emits_action() {
    ...
    server.request(json!({
        ...
        "id": 2,
        "method": "tools/call",
        "params": { "name": "system", "arguments": { "op": "call", "cmd": "system.init", "args": { "workspace": "ws_re_bm6" } } }
    }));
    ...
    server.request(json!({
        ...
        "id": 5,
        "method": "tools/call",
        "params": { "name": "think", "arguments": { "op": "call", "cmd": "think.pin", "args": { "workspace": "ws_re_bm6", "targets": ["A1", "D1"], "pinned": true } } }
    }));
    ...
    server.request(json!({
        ...
        "id": 6,
        "method": "tools/call",
        "params": { "name": "think", "arguments": { "op": "call", "cmd": "think.set.status", "args": { "workspace": "ws_re_bm6", "targets": ["A1"], "status": "rejected" } } }
    }));
    ...
    let watch = server.request(json!({
        ...
        "id": 7,
        "method": "tools/call",
        "params": { "name": "think", "arguments": { "op": "call", "cmd": "think.watch", "args": { "workspace": "ws_re_bm6", "engine_signals_limit": 20, "engine_actions_limit": 20, "limit_candidates": 10 } } }
    }));
    let watch_text = extract_tool_text(&watch);
    let engine = watch_text
        .get("result")
...
fn reasoning_engine_bm7_counter_hypothesis_is_suggested() {
    ...
    server.request(json!({
        ...
        "id": 2,
        "method": "tools/call",
        "params": { "name": "system", "arguments": { "op": "call", "cmd": "system.init", "args": { "workspace": "ws_re_bm7" } } }
    }));
    ...
    server.request(json!({
        ...
        "id": 5,
        "method": "tools/call",
        "params": { "name": "think", "arguments": { "op": "call", "cmd": "think.pin", "args": { "workspace": "ws_re_bm7", "targets": ["H1", "E1"], "pinned": true } } }
    }));
    ...
    let watch = server.request(json!({
        ...
        "id": 6,
        "method": "tools/call",
        "params": { "name": "think", "arguments": { "op": "call", "cmd": "think.watch", "args": { "workspace": "ws_re_bm7", "engine_signals_limit": 20, "engine_actions_limit": 20, "limit_candidates": 10 } } }
    }));
    let watch_text = extract_tool_text(&watch);
    let engine = watch_text
        .get("result")
